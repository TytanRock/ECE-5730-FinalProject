...
module MATRIX_CALCULATOR_mm_interconnect_0 (
	...
	wire  [16:0] readval_s1_agent_m0_address;                                                        // readval_s1_agent:m0_address -> readval_s1_translator:uav_address
	...
	wire  [93:0] readval_s1_agent_rf_source_data;                                                    // readval_s1_agent:rf_source_data -> readval_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] readval_s1_agent_rsp_fifo_out_data;                                                 // readval_s1_agent_rsp_fifo:out_data -> readval_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> readval_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // readval_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> readval_s1_agent:cp_channel
	...
	wire  [16:0] nextval_s1_agent_m0_address;                                                        // nextval_s1_agent:m0_address -> nextval_s1_translator:uav_address
	...
	wire  [93:0] nextval_s1_agent_rf_source_data;                                                    // nextval_s1_agent:rf_source_data -> nextval_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] nextval_s1_agent_rsp_fifo_out_data;                                                 // nextval_s1_agent_rsp_fifo:out_data -> nextval_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> nextval_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // nextval_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> nextval_s1_agent:cp_channel
	...
	wire  [92:0] readval_s1_agent_rp_data;                                                           // readval_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [92:0] nextval_s1_agent_rp_data;                                                           // nextval_s1_agent:rp_data -> router_006:sink_data
