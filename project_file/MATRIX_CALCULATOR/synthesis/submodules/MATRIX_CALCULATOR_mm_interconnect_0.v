// MATRIX_CALCULATOR_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module MATRIX_CALCULATOR_mm_interconnect_0 (
		...
		output wire [1:0]  nextval_s1_address,                             //                               nextval_s1.address
		output wire        nextval_s1_write,                               //                                         .write
		input  wire [31:0] nextval_s1_readdata,                            //                                         .readdata
		output wire [31:0] nextval_s1_writedata,                           //                                         .writedata
		output wire        nextval_s1_chipselect,                          //                                         .chipselect
		output wire [1:0]  nextwriteval_s1_address,                        //                          nextwriteval_s1.address
		output wire        nextwriteval_s1_write,                          //                                         .write
		input  wire [31:0] nextwriteval_s1_readdata,                       //                                         .readdata
		output wire [31:0] nextwriteval_s1_writedata,                      //                                         .writedata
		output wire        nextwriteval_s1_chipselect,                     //                                         .chipselect
		...
		output wire [1:0]  readval_s1_address,                             //                               readval_s1.address
		input  wire [31:0] readval_s1_readdata,                            //                                         .readdata
		output wire [1:0]  writeval_s1_address,                            //                              writeval_s1.address
		output wire        writeval_s1_write,                              //                                         .write
		input  wire [31:0] writeval_s1_readdata,                           //                                         .readdata
		output wire [31:0] writeval_s1_writedata,                          //                                         .writedata
		output wire        writeval_s1_chipselect                          //                                         .chipselect
	);
	...
	wire  [31:0] readval_s1_agent_m0_readdata;                                                       // readval_s1_translator:uav_readdata -> readval_s1_agent:m0_readdata
	wire         readval_s1_agent_m0_waitrequest;                                                    // readval_s1_translator:uav_waitrequest -> readval_s1_agent:m0_waitrequest
	wire         readval_s1_agent_m0_debugaccess;                                                    // readval_s1_agent:m0_debugaccess -> readval_s1_translator:uav_debugaccess
	wire  [17:0] readval_s1_agent_m0_address;                                                        // readval_s1_agent:m0_address -> readval_s1_translator:uav_address
	wire   [3:0] readval_s1_agent_m0_byteenable;                                                     // readval_s1_agent:m0_byteenable -> readval_s1_translator:uav_byteenable
	wire         readval_s1_agent_m0_read;                                                           // readval_s1_agent:m0_read -> readval_s1_translator:uav_read
	wire         readval_s1_agent_m0_readdatavalid;                                                  // readval_s1_translator:uav_readdatavalid -> readval_s1_agent:m0_readdatavalid
	wire         readval_s1_agent_m0_lock;                                                           // readval_s1_agent:m0_lock -> readval_s1_translator:uav_lock
	wire  [31:0] readval_s1_agent_m0_writedata;                                                      // readval_s1_agent:m0_writedata -> readval_s1_translator:uav_writedata
	wire         readval_s1_agent_m0_write;                                                          // readval_s1_agent:m0_write -> readval_s1_translator:uav_write
	wire   [2:0] readval_s1_agent_m0_burstcount;                                                     // readval_s1_agent:m0_burstcount -> readval_s1_translator:uav_burstcount
	wire         readval_s1_agent_rf_source_valid;                                                   // readval_s1_agent:rf_source_valid -> readval_s1_agent_rsp_fifo:in_valid
	wire  [94:0] readval_s1_agent_rf_source_data;                                                    // readval_s1_agent:rf_source_data -> readval_s1_agent_rsp_fifo:in_data
	wire         readval_s1_agent_rf_source_ready;                                                   // readval_s1_agent_rsp_fifo:in_ready -> readval_s1_agent:rf_source_ready
	wire         readval_s1_agent_rf_source_startofpacket;                                           // readval_s1_agent:rf_source_startofpacket -> readval_s1_agent_rsp_fifo:in_startofpacket
	wire         readval_s1_agent_rf_source_endofpacket;                                             // readval_s1_agent:rf_source_endofpacket -> readval_s1_agent_rsp_fifo:in_endofpacket
	wire         readval_s1_agent_rsp_fifo_out_valid;                                                // readval_s1_agent_rsp_fifo:out_valid -> readval_s1_agent:rf_sink_valid
	wire  [94:0] readval_s1_agent_rsp_fifo_out_data;                                                 // readval_s1_agent_rsp_fifo:out_data -> readval_s1_agent:rf_sink_data
	wire         readval_s1_agent_rsp_fifo_out_ready;                                                // readval_s1_agent:rf_sink_ready -> readval_s1_agent_rsp_fifo:out_ready
	wire         readval_s1_agent_rsp_fifo_out_startofpacket;                                        // readval_s1_agent_rsp_fifo:out_startofpacket -> readval_s1_agent:rf_sink_startofpacket
	wire         readval_s1_agent_rsp_fifo_out_endofpacket;                                          // readval_s1_agent_rsp_fifo:out_endofpacket -> readval_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> readval_s1_agent:cp_valid
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> readval_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // readval_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> readval_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> readval_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> readval_s1_agent:cp_endofpacket
	wire  [31:0] nextval_s1_agent_m0_readdata;                                                       // nextval_s1_translator:uav_readdata -> nextval_s1_agent:m0_readdata
	wire         nextval_s1_agent_m0_waitrequest;                                                    // nextval_s1_translator:uav_waitrequest -> nextval_s1_agent:m0_waitrequest
	wire         nextval_s1_agent_m0_debugaccess;                                                    // nextval_s1_agent:m0_debugaccess -> nextval_s1_translator:uav_debugaccess
	wire  [17:0] nextval_s1_agent_m0_address;                                                        // nextval_s1_agent:m0_address -> nextval_s1_translator:uav_address
	wire   [3:0] nextval_s1_agent_m0_byteenable;                                                     // nextval_s1_agent:m0_byteenable -> nextval_s1_translator:uav_byteenable
	wire         nextval_s1_agent_m0_read;                                                           // nextval_s1_agent:m0_read -> nextval_s1_translator:uav_read
	wire         nextval_s1_agent_m0_readdatavalid;                                                  // nextval_s1_translator:uav_readdatavalid -> nextval_s1_agent:m0_readdatavalid
	wire         nextval_s1_agent_m0_lock;                                                           // nextval_s1_agent:m0_lock -> nextval_s1_translator:uav_lock
	wire  [31:0] nextval_s1_agent_m0_writedata;                                                      // nextval_s1_agent:m0_writedata -> nextval_s1_translator:uav_writedata
	wire         nextval_s1_agent_m0_write;                                                          // nextval_s1_agent:m0_write -> nextval_s1_translator:uav_write
	wire   [2:0] nextval_s1_agent_m0_burstcount;                                                     // nextval_s1_agent:m0_burstcount -> nextval_s1_translator:uav_burstcount
	wire         nextval_s1_agent_rf_source_valid;                                                   // nextval_s1_agent:rf_source_valid -> nextval_s1_agent_rsp_fifo:in_valid
	wire  [94:0] nextval_s1_agent_rf_source_data;                                                    // nextval_s1_agent:rf_source_data -> nextval_s1_agent_rsp_fifo:in_data
	wire         nextval_s1_agent_rf_source_ready;                                                   // nextval_s1_agent_rsp_fifo:in_ready -> nextval_s1_agent:rf_source_ready
	wire         nextval_s1_agent_rf_source_startofpacket;                                           // nextval_s1_agent:rf_source_startofpacket -> nextval_s1_agent_rsp_fifo:in_startofpacket
	wire         nextval_s1_agent_rf_source_endofpacket;                                             // nextval_s1_agent:rf_source_endofpacket -> nextval_s1_agent_rsp_fifo:in_endofpacket
	wire         nextval_s1_agent_rsp_fifo_out_valid;                                                // nextval_s1_agent_rsp_fifo:out_valid -> nextval_s1_agent:rf_sink_valid
	wire  [94:0] nextval_s1_agent_rsp_fifo_out_data;                                                 // nextval_s1_agent_rsp_fifo:out_data -> nextval_s1_agent:rf_sink_data
	wire         nextval_s1_agent_rsp_fifo_out_ready;                                                // nextval_s1_agent:rf_sink_ready -> nextval_s1_agent_rsp_fifo:out_ready
	wire         nextval_s1_agent_rsp_fifo_out_startofpacket;                                        // nextval_s1_agent_rsp_fifo:out_startofpacket -> nextval_s1_agent:rf_sink_startofpacket
	wire         nextval_s1_agent_rsp_fifo_out_endofpacket;                                          // nextval_s1_agent_rsp_fifo:out_endofpacket -> nextval_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> nextval_s1_agent:cp_valid
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> nextval_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // nextval_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> nextval_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> nextval_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> nextval_s1_agent:cp_endofpacket
	wire  [31:0] writeval_s1_agent_m0_readdata;                                                      // writeval_s1_translator:uav_readdata -> writeval_s1_agent:m0_readdata
	wire         writeval_s1_agent_m0_waitrequest;                                                   // writeval_s1_translator:uav_waitrequest -> writeval_s1_agent:m0_waitrequest
	wire         writeval_s1_agent_m0_debugaccess;                                                   // writeval_s1_agent:m0_debugaccess -> writeval_s1_translator:uav_debugaccess
	wire  [17:0] writeval_s1_agent_m0_address;                                                       // writeval_s1_agent:m0_address -> writeval_s1_translator:uav_address
	wire   [3:0] writeval_s1_agent_m0_byteenable;                                                    // writeval_s1_agent:m0_byteenable -> writeval_s1_translator:uav_byteenable
	wire         writeval_s1_agent_m0_read;                                                          // writeval_s1_agent:m0_read -> writeval_s1_translator:uav_read
	wire         writeval_s1_agent_m0_readdatavalid;                                                 // writeval_s1_translator:uav_readdatavalid -> writeval_s1_agent:m0_readdatavalid
	wire         writeval_s1_agent_m0_lock;                                                          // writeval_s1_agent:m0_lock -> writeval_s1_translator:uav_lock
	wire  [31:0] writeval_s1_agent_m0_writedata;                                                     // writeval_s1_agent:m0_writedata -> writeval_s1_translator:uav_writedata
	wire         writeval_s1_agent_m0_write;                                                         // writeval_s1_agent:m0_write -> writeval_s1_translator:uav_write
	wire   [2:0] writeval_s1_agent_m0_burstcount;                                                    // writeval_s1_agent:m0_burstcount -> writeval_s1_translator:uav_burstcount
	wire         writeval_s1_agent_rf_source_valid;                                                  // writeval_s1_agent:rf_source_valid -> writeval_s1_agent_rsp_fifo:in_valid
	wire  [94:0] writeval_s1_agent_rf_source_data;                                                   // writeval_s1_agent:rf_source_data -> writeval_s1_agent_rsp_fifo:in_data
	wire         writeval_s1_agent_rf_source_ready;                                                  // writeval_s1_agent_rsp_fifo:in_ready -> writeval_s1_agent:rf_source_ready
	wire         writeval_s1_agent_rf_source_startofpacket;                                          // writeval_s1_agent:rf_source_startofpacket -> writeval_s1_agent_rsp_fifo:in_startofpacket
	wire         writeval_s1_agent_rf_source_endofpacket;                                            // writeval_s1_agent:rf_source_endofpacket -> writeval_s1_agent_rsp_fifo:in_endofpacket
	wire         writeval_s1_agent_rsp_fifo_out_valid;                                               // writeval_s1_agent_rsp_fifo:out_valid -> writeval_s1_agent:rf_sink_valid
	wire  [94:0] writeval_s1_agent_rsp_fifo_out_data;                                                // writeval_s1_agent_rsp_fifo:out_data -> writeval_s1_agent:rf_sink_data
	wire         writeval_s1_agent_rsp_fifo_out_ready;                                               // writeval_s1_agent:rf_sink_ready -> writeval_s1_agent_rsp_fifo:out_ready
	wire         writeval_s1_agent_rsp_fifo_out_startofpacket;                                       // writeval_s1_agent_rsp_fifo:out_startofpacket -> writeval_s1_agent:rf_sink_startofpacket
	wire         writeval_s1_agent_rsp_fifo_out_endofpacket;                                         // writeval_s1_agent_rsp_fifo:out_endofpacket -> writeval_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> writeval_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> writeval_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // writeval_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> writeval_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> writeval_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> writeval_s1_agent:cp_endofpacket
	wire  [31:0] nextwriteval_s1_agent_m0_readdata;                                                  // nextwriteval_s1_translator:uav_readdata -> nextwriteval_s1_agent:m0_readdata
	wire         nextwriteval_s1_agent_m0_waitrequest;                                               // nextwriteval_s1_translator:uav_waitrequest -> nextwriteval_s1_agent:m0_waitrequest
	wire         nextwriteval_s1_agent_m0_debugaccess;                                               // nextwriteval_s1_agent:m0_debugaccess -> nextwriteval_s1_translator:uav_debugaccess
	wire  [17:0] nextwriteval_s1_agent_m0_address;                                                   // nextwriteval_s1_agent:m0_address -> nextwriteval_s1_translator:uav_address
	wire   [3:0] nextwriteval_s1_agent_m0_byteenable;                                                // nextwriteval_s1_agent:m0_byteenable -> nextwriteval_s1_translator:uav_byteenable
	wire         nextwriteval_s1_agent_m0_read;                                                      // nextwriteval_s1_agent:m0_read -> nextwriteval_s1_translator:uav_read
	wire         nextwriteval_s1_agent_m0_readdatavalid;                                             // nextwriteval_s1_translator:uav_readdatavalid -> nextwriteval_s1_agent:m0_readdatavalid
	wire         nextwriteval_s1_agent_m0_lock;                                                      // nextwriteval_s1_agent:m0_lock -> nextwriteval_s1_translator:uav_lock
	wire  [31:0] nextwriteval_s1_agent_m0_writedata;                                                 // nextwriteval_s1_agent:m0_writedata -> nextwriteval_s1_translator:uav_writedata
	wire         nextwriteval_s1_agent_m0_write;                                                     // nextwriteval_s1_agent:m0_write -> nextwriteval_s1_translator:uav_write
	wire   [2:0] nextwriteval_s1_agent_m0_burstcount;                                                // nextwriteval_s1_agent:m0_burstcount -> nextwriteval_s1_translator:uav_burstcount
	wire         nextwriteval_s1_agent_rf_source_valid;                                              // nextwriteval_s1_agent:rf_source_valid -> nextwriteval_s1_agent_rsp_fifo:in_valid
	wire  [94:0] nextwriteval_s1_agent_rf_source_data;                                               // nextwriteval_s1_agent:rf_source_data -> nextwriteval_s1_agent_rsp_fifo:in_data
	wire         nextwriteval_s1_agent_rf_source_ready;                                              // nextwriteval_s1_agent_rsp_fifo:in_ready -> nextwriteval_s1_agent:rf_source_ready
	wire         nextwriteval_s1_agent_rf_source_startofpacket;                                      // nextwriteval_s1_agent:rf_source_startofpacket -> nextwriteval_s1_agent_rsp_fifo:in_startofpacket
	wire         nextwriteval_s1_agent_rf_source_endofpacket;                                        // nextwriteval_s1_agent:rf_source_endofpacket -> nextwriteval_s1_agent_rsp_fifo:in_endofpacket
	wire         nextwriteval_s1_agent_rsp_fifo_out_valid;                                           // nextwriteval_s1_agent_rsp_fifo:out_valid -> nextwriteval_s1_agent:rf_sink_valid
	wire  [94:0] nextwriteval_s1_agent_rsp_fifo_out_data;                                            // nextwriteval_s1_agent_rsp_fifo:out_data -> nextwriteval_s1_agent:rf_sink_data
	wire         nextwriteval_s1_agent_rsp_fifo_out_ready;                                           // nextwriteval_s1_agent:rf_sink_ready -> nextwriteval_s1_agent_rsp_fifo:out_ready
	wire         nextwriteval_s1_agent_rsp_fifo_out_startofpacket;                                   // nextwriteval_s1_agent_rsp_fifo:out_startofpacket -> nextwriteval_s1_agent:rf_sink_startofpacket
	wire         nextwriteval_s1_agent_rsp_fifo_out_endofpacket;                                     // nextwriteval_s1_agent_rsp_fifo:out_endofpacket -> nextwriteval_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> nextwriteval_s1_agent:cp_valid
	wire  [93:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> nextwriteval_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // nextwriteval_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> nextwriteval_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> nextwriteval_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> nextwriteval_s1_agent:cp_endofpacket
	...
	wire         readval_s1_agent_rp_valid;                                                          // readval_s1_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] readval_s1_agent_rp_data;                                                           // readval_s1_agent:rp_data -> router_005:sink_data
	wire         readval_s1_agent_rp_ready;                                                          // router_005:sink_ready -> readval_s1_agent:rp_ready
	wire         readval_s1_agent_rp_startofpacket;                                                  // readval_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         readval_s1_agent_rp_endofpacket;                                                    // readval_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         nextval_s1_agent_rp_valid;                                                          // nextval_s1_agent:rp_valid -> router_006:sink_valid
	wire  [93:0] nextval_s1_agent_rp_data;                                                           // nextval_s1_agent:rp_data -> router_006:sink_data
	wire         nextval_s1_agent_rp_ready;                                                          // router_006:sink_ready -> nextval_s1_agent:rp_ready
	wire         nextval_s1_agent_rp_startofpacket;                                                  // nextval_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         nextval_s1_agent_rp_endofpacket;                                                    // nextval_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         writeval_s1_agent_rp_valid;                                                         // writeval_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] writeval_s1_agent_rp_data;                                                          // writeval_s1_agent:rp_data -> router_007:sink_data
	wire         writeval_s1_agent_rp_ready;                                                         // router_007:sink_ready -> writeval_s1_agent:rp_ready
	wire         writeval_s1_agent_rp_startofpacket;                                                 // writeval_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         writeval_s1_agent_rp_endofpacket;                                                   // writeval_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         nextwriteval_s1_agent_rp_valid;                                                     // nextwriteval_s1_agent:rp_valid -> router_008:sink_valid
	wire  [93:0] nextwriteval_s1_agent_rp_data;                                                      // nextwriteval_s1_agent:rp_data -> router_008:sink_data
	wire         nextwriteval_s1_agent_rp_ready;                                                     // router_008:sink_ready -> nextwriteval_s1_agent:rp_ready
	wire         nextwriteval_s1_agent_rp_startofpacket;                                             // nextwriteval_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         nextwriteval_s1_agent_rp_endofpacket;                                               // nextwriteval_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         readval_s1_agent_rdata_fifo_src_valid;                                              // readval_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] readval_s1_agent_rdata_fifo_src_data;                                               // readval_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         readval_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_003:in_0_ready -> readval_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> readval_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> readval_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // readval_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> readval_s1_agent:rdata_fifo_sink_error
	wire         nextval_s1_agent_rdata_fifo_src_valid;                                              // nextval_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] nextval_s1_agent_rdata_fifo_src_data;                                               // nextval_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         nextval_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_004:in_0_ready -> nextval_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> nextval_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> nextval_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // nextval_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> nextval_s1_agent:rdata_fifo_sink_error
	wire         writeval_s1_agent_rdata_fifo_src_valid;                                             // writeval_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] writeval_s1_agent_rdata_fifo_src_data;                                              // writeval_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         writeval_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_005:in_0_ready -> writeval_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> writeval_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> writeval_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // writeval_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> writeval_s1_agent:rdata_fifo_sink_error
	wire         nextwriteval_s1_agent_rdata_fifo_src_valid;                                         // nextwriteval_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] nextwriteval_s1_agent_rdata_fifo_src_data;                                          // nextwriteval_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         nextwriteval_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_006:in_0_ready -> nextwriteval_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> nextwriteval_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> nextwriteval_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // nextwriteval_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> nextwriteval_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) readval_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (readval_s1_agent_m0_address),                    // avalon_universal_slave_0.address
		.uav_burstcount         (readval_s1_agent_m0_burstcount),                 //                         .burstcount
		.uav_read               (readval_s1_agent_m0_read),                       //                         .read
		.uav_write              (readval_s1_agent_m0_write),                      //                         .write
		.uav_waitrequest        (readval_s1_agent_m0_waitrequest),                //                         .waitrequest
		.uav_readdatavalid      (readval_s1_agent_m0_readdatavalid),              //                         .readdatavalid
		.uav_byteenable         (readval_s1_agent_m0_byteenable),                 //                         .byteenable
		.uav_readdata           (readval_s1_agent_m0_readdata),                   //                         .readdata
		.uav_writedata          (readval_s1_agent_m0_writedata),                  //                         .writedata
		.uav_lock               (readval_s1_agent_m0_lock),                       //                         .lock
		.uav_debugaccess        (readval_s1_agent_m0_debugaccess),                //                         .debugaccess
		.av_address             (readval_s1_address),                             //      avalon_anti_slave_0.address
		.av_readdata            (readval_s1_readdata),                            //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) nextval_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (nextval_s1_agent_m0_address),                    // avalon_universal_slave_0.address
		.uav_burstcount         (nextval_s1_agent_m0_burstcount),                 //                         .burstcount
		.uav_read               (nextval_s1_agent_m0_read),                       //                         .read
		.uav_write              (nextval_s1_agent_m0_write),                      //                         .write
		.uav_waitrequest        (nextval_s1_agent_m0_waitrequest),                //                         .waitrequest
		.uav_readdatavalid      (nextval_s1_agent_m0_readdatavalid),              //                         .readdatavalid
		.uav_byteenable         (nextval_s1_agent_m0_byteenable),                 //                         .byteenable
		.uav_readdata           (nextval_s1_agent_m0_readdata),                   //                         .readdata
		.uav_writedata          (nextval_s1_agent_m0_writedata),                  //                         .writedata
		.uav_lock               (nextval_s1_agent_m0_lock),                       //                         .lock
		.uav_debugaccess        (nextval_s1_agent_m0_debugaccess),                //                         .debugaccess
		.av_address             (nextval_s1_address),                             //      avalon_anti_slave_0.address
		.av_write               (nextval_s1_write),                               //                         .write
		.av_readdata            (nextval_s1_readdata),                            //                         .readdata
		.av_writedata           (nextval_s1_writedata),                           //                         .writedata
		.av_chipselect          (nextval_s1_chipselect),                          //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) writeval_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (writeval_s1_agent_m0_address),                   // avalon_universal_slave_0.address
		.uav_burstcount         (writeval_s1_agent_m0_burstcount),                //                         .burstcount
		.uav_read               (writeval_s1_agent_m0_read),                      //                         .read
		.uav_write              (writeval_s1_agent_m0_write),                     //                         .write
		.uav_waitrequest        (writeval_s1_agent_m0_waitrequest),               //                         .waitrequest
		.uav_readdatavalid      (writeval_s1_agent_m0_readdatavalid),             //                         .readdatavalid
		.uav_byteenable         (writeval_s1_agent_m0_byteenable),                //                         .byteenable
		.uav_readdata           (writeval_s1_agent_m0_readdata),                  //                         .readdata
		.uav_writedata          (writeval_s1_agent_m0_writedata),                 //                         .writedata
		.uav_lock               (writeval_s1_agent_m0_lock),                      //                         .lock
		.uav_debugaccess        (writeval_s1_agent_m0_debugaccess),               //                         .debugaccess
		.av_address             (writeval_s1_address),                            //      avalon_anti_slave_0.address
		.av_write               (writeval_s1_write),                              //                         .write
		.av_readdata            (writeval_s1_readdata),                           //                         .readdata
		.av_writedata           (writeval_s1_writedata),                          //                         .writedata
		.av_chipselect          (writeval_s1_chipselect),                         //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) nextwriteval_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (nextwriteval_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (nextwriteval_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (nextwriteval_s1_agent_m0_read),                  //                         .read
		.uav_write              (nextwriteval_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (nextwriteval_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (nextwriteval_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (nextwriteval_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (nextwriteval_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (nextwriteval_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (nextwriteval_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (nextwriteval_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (nextwriteval_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (nextwriteval_s1_write),                          //                         .write
		.av_readdata            (nextwriteval_s1_readdata),                       //                         .readdata
		.av_writedata           (nextwriteval_s1_writedata),                      //                         .writedata
		.av_chipselect          (nextwriteval_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (readval_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (readval_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (readval_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (readval_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (readval_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (readval_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (readval_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (readval_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (readval_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (readval_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (readval_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (readval_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (readval_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (readval_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (readval_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (readval_s1_agent_rp_startofpacket),              //                .startofpacket
		...
		.rf_sink_ready           (readval_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (readval_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (readval_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (readval_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (readval_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (readval_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (readval_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (readval_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (readval_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (readval_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),              //                .error
		.rdata_fifo_src_ready    (readval_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (readval_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (readval_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) readval_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (readval_s1_agent_rf_source_data),                //        in.data
		.in_valid          (readval_s1_agent_rf_source_valid),               //          .valid
		.in_ready          (readval_s1_agent_rf_source_ready),               //          .ready
		.in_startofpacket  (readval_s1_agent_rf_source_startofpacket),       //          .startofpacket
		.in_endofpacket    (readval_s1_agent_rf_source_endofpacket),         //          .endofpacket
		.out_data          (readval_s1_agent_rsp_fifo_out_data),             //       out.data
		.out_valid         (readval_s1_agent_rsp_fifo_out_valid),            //          .valid
		.out_ready         (readval_s1_agent_rsp_fifo_out_ready),            //          .ready
		.out_startofpacket (readval_s1_agent_rsp_fifo_out_startofpacket),    //          .startofpacket
		.out_endofpacket   (readval_s1_agent_rsp_fifo_out_endofpacket),      //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (nextval_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (nextval_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (nextval_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (nextval_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (nextval_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (nextval_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (nextval_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (nextval_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (nextval_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (nextval_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (nextval_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (nextval_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (nextval_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (nextval_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (nextval_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (nextval_s1_agent_rp_startofpacket),              //                .startofpacket
		...
		.rf_sink_ready           (nextval_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (nextval_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (nextval_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (nextval_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (nextval_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (nextval_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (nextval_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (nextval_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (nextval_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (nextval_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),              //                .error
		.rdata_fifo_src_ready    (nextval_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (nextval_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (nextval_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) nextval_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (nextval_s1_agent_rf_source_data),                //        in.data
		.in_valid          (nextval_s1_agent_rf_source_valid),               //          .valid
		.in_ready          (nextval_s1_agent_rf_source_ready),               //          .ready
		.in_startofpacket  (nextval_s1_agent_rf_source_startofpacket),       //          .startofpacket
		.in_endofpacket    (nextval_s1_agent_rf_source_endofpacket),         //          .endofpacket
		.out_data          (nextval_s1_agent_rsp_fifo_out_data),             //       out.data
		.out_valid         (nextval_s1_agent_rsp_fifo_out_valid),            //          .valid
		.out_ready         (nextval_s1_agent_rsp_fifo_out_ready),            //          .ready
		.out_startofpacket (nextval_s1_agent_rsp_fifo_out_startofpacket),    //          .startofpacket
		.out_endofpacket   (nextval_s1_agent_rsp_fifo_out_endofpacket),      //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (writeval_s1_agent_m0_address),                   //              m0.address
		.m0_burstcount           (writeval_s1_agent_m0_burstcount),                //                .burstcount
		.m0_byteenable           (writeval_s1_agent_m0_byteenable),                //                .byteenable
		.m0_debugaccess          (writeval_s1_agent_m0_debugaccess),               //                .debugaccess
		.m0_lock                 (writeval_s1_agent_m0_lock),                      //                .lock
		.m0_readdata             (writeval_s1_agent_m0_readdata),                  //                .readdata
		.m0_readdatavalid        (writeval_s1_agent_m0_readdatavalid),             //                .readdatavalid
		.m0_read                 (writeval_s1_agent_m0_read),                      //                .read
		.m0_waitrequest          (writeval_s1_agent_m0_waitrequest),               //                .waitrequest
		.m0_writedata            (writeval_s1_agent_m0_writedata),                 //                .writedata
		.m0_write                (writeval_s1_agent_m0_write),                     //                .write
		.rp_endofpacket          (writeval_s1_agent_rp_endofpacket),               //              rp.endofpacket
		.rp_ready                (writeval_s1_agent_rp_ready),                     //                .ready
		.rp_valid                (writeval_s1_agent_rp_valid),                     //                .valid
		.rp_data                 (writeval_s1_agent_rp_data),                      //                .data
		.rp_startofpacket        (writeval_s1_agent_rp_startofpacket),             //                .startofpacket
		...
		.rf_sink_ready           (writeval_s1_agent_rsp_fifo_out_ready),           //         rf_sink.ready
		.rf_sink_valid           (writeval_s1_agent_rsp_fifo_out_valid),           //                .valid
		.rf_sink_startofpacket   (writeval_s1_agent_rsp_fifo_out_startofpacket),   //                .startofpacket
		.rf_sink_endofpacket     (writeval_s1_agent_rsp_fifo_out_endofpacket),     //                .endofpacket
		.rf_sink_data            (writeval_s1_agent_rsp_fifo_out_data),            //                .data
		.rf_source_ready         (writeval_s1_agent_rf_source_ready),              //       rf_source.ready
		.rf_source_valid         (writeval_s1_agent_rf_source_valid),              //                .valid
		.rf_source_startofpacket (writeval_s1_agent_rf_source_startofpacket),      //                .startofpacket
		.rf_source_endofpacket   (writeval_s1_agent_rf_source_endofpacket),        //                .endofpacket
		.rf_source_data          (writeval_s1_agent_rf_source_data),               //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),              //                .error
		.rdata_fifo_src_ready    (writeval_s1_agent_rdata_fifo_src_ready),         //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (writeval_s1_agent_rdata_fifo_src_valid),         //                .valid
		.rdata_fifo_src_data     (writeval_s1_agent_rdata_fifo_src_data),          //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) writeval_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (writeval_s1_agent_rf_source_data),               //        in.data
		.in_valid          (writeval_s1_agent_rf_source_valid),              //          .valid
		.in_ready          (writeval_s1_agent_rf_source_ready),              //          .ready
		.in_startofpacket  (writeval_s1_agent_rf_source_startofpacket),      //          .startofpacket
		.in_endofpacket    (writeval_s1_agent_rf_source_endofpacket),        //          .endofpacket
		.out_data          (writeval_s1_agent_rsp_fifo_out_data),            //       out.data
		.out_valid         (writeval_s1_agent_rsp_fifo_out_valid),           //          .valid
		.out_ready         (writeval_s1_agent_rsp_fifo_out_ready),           //          .ready
		.out_startofpacket (writeval_s1_agent_rsp_fifo_out_startofpacket),   //          .startofpacket
		.out_endofpacket   (writeval_s1_agent_rsp_fifo_out_endofpacket),     //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) nextwriteval_s1_agent (
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (nextwriteval_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (nextwriteval_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (nextwriteval_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (nextwriteval_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (nextwriteval_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (nextwriteval_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (nextwriteval_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (nextwriteval_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (nextwriteval_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (nextwriteval_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (nextwriteval_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (nextwriteval_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (nextwriteval_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (nextwriteval_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (nextwriteval_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (nextwriteval_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (nextwriteval_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (nextwriteval_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (nextwriteval_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (nextwriteval_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (nextwriteval_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (nextwriteval_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (nextwriteval_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (nextwriteval_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (nextwriteval_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (nextwriteval_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                //                .error
		.rdata_fifo_src_ready    (nextwriteval_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (nextwriteval_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (nextwriteval_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) nextwriteval_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (nextwriteval_s1_agent_rf_source_data),             //        in.data
		.in_valid          (nextwriteval_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (nextwriteval_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (nextwriteval_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (nextwriteval_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (nextwriteval_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (nextwriteval_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (nextwriteval_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (nextwriteval_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (nextwriteval_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	MATRIX_CALCULATOR_mm_interconnect_0_router router (
	...
	MATRIX_CALCULATOR_mm_interconnect_0_router_001 router_001 (
	...
	MATRIX_CALCULATOR_mm_interconnect_0_router_002 router_002 (
	...
	MATRIX_CALCULATOR_mm_interconnect_0_router_003 router_003 (
	...
	MATRIX_CALCULATOR_mm_interconnect_0_router_003 router_004 (
	...
	MATRIX_CALCULATOR_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (readval_s1_agent_rp_ready),                      //      sink.ready
		.sink_valid         (readval_s1_agent_rp_valid),                      //          .valid
		.sink_data          (readval_s1_agent_rp_data),                       //          .data
		.sink_startofpacket (readval_s1_agent_rp_startofpacket),              //          .startofpacket
		.sink_endofpacket   (readval_s1_agent_rp_endofpacket),                //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (nextval_s1_agent_rp_ready),                      //      sink.ready
		.sink_valid         (nextval_s1_agent_rp_valid),                      //          .valid
		.sink_data          (nextval_s1_agent_rp_data),                       //          .data
		.sink_startofpacket (nextval_s1_agent_rp_startofpacket),              //          .startofpacket
		.sink_endofpacket   (nextval_s1_agent_rp_endofpacket),                //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (writeval_s1_agent_rp_ready),                     //      sink.ready
		.sink_valid         (writeval_s1_agent_rp_valid),                     //          .valid
		.sink_data          (writeval_s1_agent_rp_data),                      //          .data
		.sink_startofpacket (writeval_s1_agent_rp_startofpacket),             //          .startofpacket
		.sink_endofpacket   (writeval_s1_agent_rp_endofpacket),               //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (nextwriteval_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (nextwriteval_s1_agent_rp_valid),                 //          .valid
		.sink_data          (nextwriteval_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (nextwriteval_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (nextwriteval_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MATRIX_CALCULATOR_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	MATRIX_CALCULATOR_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (readval_s1_agent_rdata_fifo_src_data),           //     in_0.data
		.in_0_valid     (readval_s1_agent_rdata_fifo_src_valid),          //         .valid
		.in_0_ready     (readval_s1_agent_rdata_fifo_src_ready),          //         .ready
	...
	MATRIX_CALCULATOR_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (nextval_s1_agent_rdata_fifo_src_data),           //     in_0.data
		.in_0_valid     (nextval_s1_agent_rdata_fifo_src_valid),          //         .valid
		.in_0_ready     (nextval_s1_agent_rdata_fifo_src_ready),          //         .ready
	...
	MATRIX_CALCULATOR_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (writeval_s1_agent_rdata_fifo_src_data),          //     in_0.data
		.in_0_valid     (writeval_s1_agent_rdata_fifo_src_valid),         //         .valid
		.in_0_ready     (writeval_s1_agent_rdata_fifo_src_ready),         //         .ready
	...
	MATRIX_CALCULATOR_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (nextwriteval_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (nextwriteval_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (nextwriteval_s1_agent_rdata_fifo_src_ready),     //         .ready
